...
# Helper function for progressive training
...
#     num_classes=6,
#     loss_weight=None,
#     epochs_per_phase=[20, 30, 20],
#     checkpoint_dir="checkpoints"
# ):
#     """
#     Create trainers for progressive training phases
#     """
#     trainers = {}
    
#     # Phase 1: Multimodal training
#     multimodal_classifier = EgoDriveClassifier(
#         model=model,
#         num_classes=num_classes,
#         lr=1e-4,
#         use_loss_weight=loss_weight is not None,
...
#     hallucination_classifier = EgoDriveClassifier(
#         model=model,
#         num_classes=num_classes,
#         lr=5e-5,
#         use_loss_weight=loss_weight is not None,
#         loss_weight=loss_weight,
#         training_phase='hallucination',
#         warmup_steps=300
#     )
    
#     # Phase 3: RGB-only training
#     rgb_only_classifier = EgoDriveClassifier(
#         model=model,
#         num_classes=num_classes,
#         lr=1e-5,
#         use_loss_weight=loss_weight is not None,
#         loss_weight=loss_weight,
#         training_phase='rgb_only',
#         warmup_steps=100
#     )
    
#     return {
#         'multimodal': multimodal_classifier,
#         'hallucination': hallucination_classifier,
#         'rgb_only': rgb_only_classifier
#     }